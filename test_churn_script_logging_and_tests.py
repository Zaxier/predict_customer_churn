...
def test_train_models():
    ...
    # cleaning directory
    necessary_img_pths = {'images/results/rf_results.png',
    ...
    encoded_df = encoder_helper(df, cat_columns, '_Churn')
    ...
    for pth in necessary_img_pths:
        try:
            assert pth in resultant_image_files
            logging.info('SUCCESS: Testing train_models: classification report outputted for %s', pth)
        except AssertionError as err:
            logging.error(
                'Testing train_models: %s classification report not generated by train_models() function', pth)
            raise err
